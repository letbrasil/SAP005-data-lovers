...
export const quizRm = {
  ...
  "questions" : [ " ", "Question 1 - are in a group, stuck in the galaxy, so:",
    ...
    "answers" : [ " " , "I insist on executing a plan that I know will work.",
      ...
      "I take it, but with a gun ready to shoot!", 
      "If he's handsome, I trust him and I even stay in his planet!", 
      "I take it and trust him, I have no other choice.",
      ...
      "NO WAY! TO EXISTENCE IS TO SUFFER!", 
...
export const resultScreenTest = {
    ...
    "tinyRick" : ["Tiny Rick <br><br> Main characteristics: Determination and self-destruction <br><br> Tiny Rick is a young clone of Rick, used to get to join his grandchildren's school and help them with a mission. Tiny Rick has the same characteristics as Rick, and because he is still young he is more positive and altruistic than his older version. However, his conscience still has traces of old-Rick, which makes him have self-destructive thoughts eventually.", "./teste-personalidadeRM/img-test/tiny-rick.jpg"],
